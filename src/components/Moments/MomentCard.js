// src/components/Moments/MomentCard.js
...
const MomentCard = ({ moment, isEditing, updatedContent, onContentChange, onSave, onCommentIconClick }) => {
    return (
        <Card sx={{backgroundColor: colors.white, width: 1, mt: 2, ml: 0, mr: 0, boxShadow: 'none'}}>
            <Box sx={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                ...
                <Box sx={{display: 'flex', alignItems: 'center', mt: 2}}>
                    ...
                    <CommentIcon sx={{ml: 2}} onClick={onCommentIconClick}/>
